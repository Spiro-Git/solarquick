...
var n = __toESM(require_leaflet_src());
var M = Object.defineProperty;
var D = (i, e, t) => e in i ? M(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
...
var v = class extends f {
  ...
  onAdd(t) {
    ...
    return c.type = "search", c.value = this.options.query, c.placeholder = this.options.placeholder, n.DomEvent.disableClickPropagation(c), this._errorElement = n.DomUtil.create("div", s + "-form-no-error", o), this._errorElement.innerHTML = this.options.errorMessage, this._alts = n.DomUtil.create(
      ...
      this.options.collapsed && !this._preventBlurCollapse && this._collapse(), this._preventBlurCollapse = false;
  ...
  _createAlt(t, s) {
    const o = n.DomUtil.create("li", ""), r = n.DomUtil.create("a", "", o), a = this.options.showResultIcons && t.icon ? n.DomUtil.create("img", "", r) : null, c = t.html ? void 0 : document.createTextNode(t.name), d = (u) => {
      this._preventBlurCollapse = true, n.DomEvent.stop(u), this._geocodeResultSelected(t), n.DomEvent.on(o, "click touchend", () => {
  ...
  _change() {
    ...
    t !== this._lastGeocode && (clearTimeout(this._suggestTimeout), t.length >= this.options.suggestMinLength ? this._suggestTimeout = setTimeout(() => this._geocode(true), this.options.suggestTimeout) : this._clearResults());
  }
};
function de(i) {
  return new v(i);
...
leaflet-control-geocoder/dist/Control.Geocoder.modern.js:
  (* @preserve
   * Leaflet Control Geocoder
   ...
   *)
*/
//# sourceMappingURL=leaflet-control-geocoder.js.map
